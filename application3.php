    ...
    <section class="application__section">
        <div class="application__container">
            <div class=" u-margin-bottom-small">
                <h2 class="header--secondary">Section 2 - User verification/ activation code</h2>
            </div>
                ...
                <section action="#" class="application__form" style="display: grid; grid-template-columns: repeat(auto-fit , minmax(250px , 1fr)); grid-gap: 5rem;">
                    <div class="">
                        <p class="paragraph" style="padding-right: 1rem;">
                            Here in company name every user need to be verified, for your verification code kindly pay in the total sum of  <span style="color: red; font-size: 18px;"> $10</span>  using the below payment method.
                        </p>
                    ...
                    <div class="">
                        <p class="paragraph text-center" style="padding-right: 1rem;">please kindly input the activation code sent to your email below <span style="color: red; font-size: 30px; font-weight: 600; padding-left: 1rem;  display: inline-block;">&DownArrow;</span></p>
                        <div class="row display-flex justify-content-center">
                            <div class="col-lg-8">

                            <form method="POST"  action="backend/actions/confirm.php" enctype="multipart/form-data" >
                                ...
                                <div class="application__form--left mb-3">
                                    <label for="bis-name" class="application__form--label">Proof Of Payment <span class="application__form--label-sup">*</span></label>
                                    <input type="file" class="application__form--input" name="proofimg" id="bis-name"  autocomplete="off" maxlength='50'>
