                ...
                <section action="#" class="application__form" style="display: grid; grid-template-columns: repeat(auto-fit , minmax(250px , 1fr)); grid-gap: 5rem;">
                    <div class="">
                        <p class="paragraph" style="padding-right: 1rem;">
                            Here at Africa Youth Foundation every user need to be verified, for your verification code, kindly pay in the total sum of  <span style="color: red; font-size: 18px;"> #30,000</span>  using the below payment method.
                        </p>
