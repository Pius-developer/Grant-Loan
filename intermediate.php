                                ...
                                <div class="u-margin-top-mid ">
                                    ...
                                    <div class="application__form mb-3">
                                        ...
                                        <input type="text" name="sl_fname" id="sl_fname" require class="application__form--input mb-3">
                                         ...
                                         <input type="hidden" value="intermediate" name="plan" id="sl_fname" require class="application__form--input mb-3">
                                    ...
                                    <div class="application__form--left mb-3">
                                        ...
                                        <input type="text" class="application__form--input" name="sl_phone" id="sl_phone" required autocomplete="off" maxlength="50">
                                    </div>

                                    <div class="application__form--left mb-3">
                                        <label for="sl_bvn" class="application_form--label"> BVN <span class="application_form--label-sup">*</span></label>
                                        <input type="text" class="application__form--input" name="sl_bvn" id="sl_bvn" required autocomplete="off" maxlength="50">
                                    </div>

                                    <div class="application__form--right mb-3">
                                        <label for="sl_gender" class="application_form--label">Choose your grnder <span class="application_form--label-sup">*</span></label>
                                    ...
                                    <div class="application__form--left mb-3">
                                        ...
                                        <input type="text" class="application__form--input" name="sl_acctnum" id="sl_acctnum" required autocomplete="off" maxlength="50">
                                    </div>
