        ...
        swal({
            ...
            window.location = "#0";
               ...
               ?>
                        ...
                        <form action="backend/loanconfirm.php" method="post" class="application__form" enctype="multipart/form-data">
                                ...
                                <div class="u-margin-top-mid ">
                                    ...
                                    <div class="application__form mb-3">
                                        ...
                                        <input type="text" name="sl_fname" id="sl_fname" require class="application__form--input mb-3">
                                         ...
                                         <input type="hidden" name="plan"  value="starter" id="sl_fname" require class="application__form--input mb-3">
