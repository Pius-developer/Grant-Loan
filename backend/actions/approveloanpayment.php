...
include 'db.php';
 ...
 //Import PHPMailer classes into the global namespace
    ...
    try {
        ...
        //Content
        $mail->isHTML(true);                                  
        $mail->Subject = 'Loan Comfirmation';
	...
	if (isset($_POST['approve'])) {
		...
		$sql = "UPDATE loanproof SET status = '$status' WHERE email = '$email' ";
		...
		header("Location:../loancomfirmproof.php?success");
		exit();

	}else{
		header("Location:../loancomfirmproof.php?error");
		exit();
	}