          ...
          <div class="col-12 col-sm-12 col-lg-12">
            <div class="card">
              <div class="card-header bg-blue">
                <h4 class="col-white">Edit Applicants Informations</h4>
              </div>
                  ...
                  <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                    <thead >
                      <tr>
                        ...
                        <th style="color:black">Application Status</th>
                        ...
                        <th style="color:black">Edit Applicants</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                        ...
                        if($result_checker > 0){
                          ...
                          while($data = mysqli_fetch_assoc($result)){
                            ...
                            echo "<tr> ";
                              ...
                              <form method='POST' action='admindepositrequest.php'>

                                 <input type='hidden' name='email' value='$email'> 

                                 <button type='submit' name='edit' class='btn' style='background-color:green;color:white'>
                                 <i class='fas fa-trash-alt'></i>Edit</button> 
                ...
                if($result_checker > 0){
                  while($data = mysqli_fetch_assoc($result)){
                            ...
                            $status  =  $data['status'];
                                        ...
                                        <div class='row'>
                                        <div class='col-12 col-md-6 col-lg-6' style='top:10px;position:absolute'>
                                        <div class='card'>
                                        
                                        <form method='POST' action='actions/editstatus.php'>
                                        <div class='card-header col-white' style='background-color:blue;''>
                                          <h4 class='col-white'><i data-feather='edit-2'></i> Edit $fname "." $lname  Application Status </h4>
                                        </div>
                                        ...
                                        <div class='card-body'>
                                          ...
                                          <button type='submit' name='edit' class='btn bg-green'><i data-feather='edit-2'></i>Edit</button>
                                          <a href='admindepositrequest.php' class='btn bg-danger col-white'><i data-feather='x'></i> Cancel</a>
