      ...
      <div class="main-sidebar sidebar-style-2 " style="background-color:#08237e">
        <aside id="sidebar-wrapper ">
          ...
          <ul class="sidebar-menu ">
            ...
            <li class="dropdown">
              <a href="trade.php" class="nav-link" style="color:orange"><i data-feather="bar-chart-2"></i><span>Trade</span></a>
            </li>
                      ...
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        <thead >
                          <tr>
                            ...
                            <th style="color:black">Date Of investment</th>
                            <th style="color:black">Investment Status</th>
                            <th style="color:black">Total earned</th>
