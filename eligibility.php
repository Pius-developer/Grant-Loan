<?php
    $page_title = "Eligibility | Company's Name";
...
<header class="header__contact">
    <div class="contact__banner">
        <div class="header__banner--content">
            <h1 class="header--primary contact__header--primary">eligibility</h1>
            <a href="index.php" class="contact__header--link">home</a> 
            <!-- <span class="contact__header--span">contact us</span> -->
            <span class="contact__header--span">applicant eligibility</span>
    ...
    <section class="eligibility__section">
        <div class="eligibility__box">
            <div class="eligibility__content">
                <p class="eligibility__content--list">
                    <span class="eligibility__content--note">NOTE</span> The kick-start programme is co-founded by FIDO and Ford foundation, the implementing organization is Salvage Africa. This application process and participation in the programme is free of charge. No salvage Africa staff or associate can influence your winning of this entrepreneurship grant. Please report anyone trying to solicit funds from you to the organization using our contact page. <a href="contact.html" class="eligibility__content--link">Click here</a> to send us a message. Or contact us via whatsapp <a href="" class="eligibility__content--link">+2349154158509</a>
                </p>
            </div>

            <div class="eligibility__content">
                <div class="eligibility__content--header u-margin-bottom-small">
                    <h3 class="header--sub-tertiary">
                        CANDIDACY CRITERIA / ELIGIBILITY
                    </h3>
                </div>
                <ul class="eligibility__content--items">
                    <li class="eligibility__content--list ">
                        The grant is open to Nigerians who live and have their business within the 36 states of Nigeria (FTC inclusive).
                    </li>
                    <li class="eligibility__content--list">
                        Applicants must be at least 18 years old and at most 40 years , with valid identification (e.g. National I.D; Drivers License; International Passport or Voters card authenticated by <a href="#" class="eligibility__content--link">Beverified</a>).
                    </li>
                    <li class="eligibility__content--list">
            ...
            <div class="eligibility__content">
                ...
                <a href="application.php" class="btn btn-grant btn--wht-bac u-margin-top-mid">agree and continue &rarr;</a>
            </div>
